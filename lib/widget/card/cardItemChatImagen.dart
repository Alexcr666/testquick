...
if(data.toString() != "null") {
 formattedDate = DateFormat('yyyy-MM-dd – kk:mm').format(
  ...
  return Container(
      ...
      decoration: estiloRedondeado( data.idUsuario == uidUser ?colorMensajeUser2:colorBlancoOpacidad,50),
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(top: 10,left: 20,bottom: 10),
                ...
                child:   ClipRRect(
                    borderRadius: BorderRadius.circular(20),child: widgetImage(data.mensaje,120,120))),
            espaciado(5, 0),
            Container(
              margin: EdgeInsets.only(right: 20),
                alignment: Alignment.centerRight,

                child: Text(formattedDate.toString(),style: estiloTexto(13,Colors.white,false))),
            espaciado(3, 0),
          ],),
      )
  );
